 # model = YOLO('/Users/doungukkim/Desktop/workspace/object-detecting-v2/trained-models/original/yolov8m.pt')
# input_video_path = '/Users/doungukkim/Desktop/workspace/object-detecting-v2/tennis/original/men-standing.mp4'
# output_video_path = '/Users/doungukkim/Desktop/workspace/object-detecting-v2/tennis/output/v5.mp4'
...
model = YOLO('/trained-models/original/yolov8m.pt')
...
def initialize_furniture(first_frame):
    ...
    furniture_results = model(first_frame, classes=safe_furniture_classes)
...
def process_frame(frame, frame_count):
    ...
    # 사람 감지 및 추적
    results = model.track(frame, persist=True, classes=[0])  # 클래스 0: person
...
def main():
    ...
    input_video_path = '/tennis/original/men-standing.mp4'
    output_video_path = '/tennis/output/men-standing-v5.mp4'
